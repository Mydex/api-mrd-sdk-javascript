...
class SearchErrorResponse {
     ...
     * @param error {module:model/SearchErrorDetails} 
     */
    constructor(error) { 
        
        SearchErrorResponse.initialize(this, error);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = SearchErrorDetails.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of SearchErrorResponse.RequiredProperties) {
        ...
        if (data['error']) { // data not null
          SearchErrorDetails.validateJSON(data['error']);
        }
...
SearchErrorResponse.RequiredProperties = ["error"];

/**
 * @member {module:model/SearchErrorDetails} error
 */
SearchErrorResponse.prototype['error'] = undefined;
