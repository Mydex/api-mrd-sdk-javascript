...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.ConditionContentNode();
  });
  ...
  describe('ConditionContentNode', function() {
    it('should create an instance of ConditionContentNode', function() {
      // uncomment below and update the code to test ConditionContentNode
      //var instance = new ApiMrdSdkJavascript.ConditionContentNode();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.ConditionContentNode);
    });
