...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.LivewellContentElementMainEntityInner();
  });
  ...
  describe('LivewellContentElementMainEntityInner', function() {
    it('should create an instance of LivewellContentElementMainEntityInner', function() {
      // uncomment below and update the code to test LivewellContentElementMainEntityInner
      //var instance = new ApiMrdSdkJavascript.LivewellContentElementMainEntityInner();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.LivewellContentElementMainEntityInner);
    });
