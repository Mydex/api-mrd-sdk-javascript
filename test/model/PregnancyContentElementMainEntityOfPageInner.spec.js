...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.PregnancyContentElementMainEntityOfPageInner();
  });
  ...
  describe('PregnancyContentElementMainEntityOfPageInner', function() {
    it('should create an instance of PregnancyContentElementMainEntityOfPageInner', function() {
      // uncomment below and update the code to test PregnancyContentElementMainEntityOfPageInner
      //var instance = new ApiMrdSdkJavascript.PregnancyContentElementMainEntityOfPageInner();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.PregnancyContentElementMainEntityOfPageInner);
    });
