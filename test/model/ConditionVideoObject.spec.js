...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.ConditionVideoObject();
  });
  ...
  describe('ConditionVideoObject', function() {
    it('should create an instance of ConditionVideoObject', function() {
      // uncomment below and update the code to test ConditionVideoObject
      //var instance = new ApiMrdSdkJavascript.ConditionVideoObject();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.ConditionVideoObject);
    });
