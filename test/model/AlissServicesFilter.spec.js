...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.AlissServicesFilter();
  });
  ...
  describe('AlissServicesFilter', function() {
    it('should create an instance of AlissServicesFilter', function() {
      // uncomment below and update the code to test AlissServicesFilter
      //var instance = new ApiMrdSdkJavascript.AlissServicesFilter();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.AlissServicesFilter);
    });
