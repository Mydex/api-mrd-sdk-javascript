...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.MedicineData();
  });
  ...
  describe('MedicineData', function() {
    it('should create an instance of MedicineData', function() {
      // uncomment below and update the code to test MedicineData
      //var instance = new ApiMrdSdkJavascript.MedicineData();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.MedicineData);
    });
