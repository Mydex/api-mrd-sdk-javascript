...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.MeasurementUnit();
  });
  ...
  describe('MeasurementUnit', function() {
    it('should create an instance of MeasurementUnit', function() {
      ...
      //var instance = new ApiMrdSdkJavascript.MeasurementUnit();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.MeasurementUnit);
    });
