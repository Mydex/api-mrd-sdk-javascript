...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.LivewellVideoObject();
  });
  ...
  describe('LivewellVideoObject', function() {
    it('should create an instance of LivewellVideoObject', function() {
      // uncomment below and update the code to test LivewellVideoObject
      //var instance = new ApiMrdSdkJavascript.LivewellVideoObject();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.LivewellVideoObject);
    });
