...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.MedicineContentElement();
  });
  ...
  describe('MedicineContentElement', function() {
    it('should create an instance of MedicineContentElement', function() {
      // uncomment below and update the code to test MedicineContentElement
      //var instance = new ApiMrdSdkJavascript.MedicineContentElement();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.MedicineContentElement);
    });
