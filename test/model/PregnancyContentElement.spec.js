...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.PregnancyContentElement();
  });
  ...
  describe('PregnancyContentElement', function() {
    it('should create an instance of PregnancyContentElement', function() {
      // uncomment below and update the code to test PregnancyContentElement
      //var instance = new ApiMrdSdkJavascript.PregnancyContentElement();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.PregnancyContentElement);
    });
