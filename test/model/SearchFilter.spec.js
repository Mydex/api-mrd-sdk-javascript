...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.SearchFilter();
  });
  ...
  describe('SearchFilter', function() {
    it('should create an instance of SearchFilter', function() {
      ...
      //var instance = new ApiMrdSdkJavascript.SearchFilter();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.SearchFilter);
    });
