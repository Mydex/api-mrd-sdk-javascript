...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.LivewellDataHasPartInner();
  });
  ...
  describe('LivewellDataHasPartInner', function() {
    it('should create an instance of LivewellDataHasPartInner', function() {
      // uncomment below and update the code to test LivewellDataHasPartInner
      //var instance = new ApiMrdSdkJavascript.LivewellDataHasPartInner();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.LivewellDataHasPartInner);
    });
    ...
    it('should have the property hasHealthAspect (base name: "hasHealthAspect")', function() {
      // uncomment below and update the code to test the property hasHealthAspect
      //var instance = new ApiMrdSdkJavascript.LivewellDataHasPartInner();
      //expect(instance).to.be();
    });
