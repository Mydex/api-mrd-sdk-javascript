...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.ConditionResponse();
  });
  ...
  describe('ConditionResponse', function() {
    it('should create an instance of ConditionResponse', function() {
      // uncomment below and update the code to test ConditionResponse
      //var instance = new ApiMrdSdkJavascript.ConditionResponse();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.ConditionResponse);
    });
