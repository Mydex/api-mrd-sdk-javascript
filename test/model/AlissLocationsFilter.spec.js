...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiMrdSdkJavascript.AlissLocationsFilter();
  });
  ...
  describe('AlissLocationsFilter', function() {
    it('should create an instance of AlissLocationsFilter', function() {
      // uncomment below and update the code to test AlissLocationsFilter
      //var instance = new ApiMrdSdkJavascript.AlissLocationsFilter();
      //expect(instance).to.be.a(ApiMrdSdkJavascript.AlissLocationsFilter);
    });
